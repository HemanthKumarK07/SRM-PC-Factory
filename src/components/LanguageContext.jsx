...
const TRANSLATIONS = {
  en: {
    ...
    hero: {
      ...
      h1_1: 'Your Machine.',
      h1_2: 'Your Rules.',
      p: 'High-performance custom PC builds tailored to your needs. Built for gamers, creators, and professionals. Trusted hardware solutions with secure ordering.',
    ...
    payment: {
      ...
      advance_lbl: 'Booking Advance (Secure Verification)',
      advance_note: 'Fully refundable on PC delivery',
      your_details: 'Your Details',
      lbl_name: 'Full Name',
      lbl_email: 'Email',
      lbl_phone: 'Phone',
      btn_continue: 'Continue to Order Confirmation →',
      sec_payment: 'Secure transaction verification · Fully refundable on delivery',
      step_2: 'Step 2 of 2 · Secure Transaction Verification',
      pay_via: 'Confirm order with ₹{amount} via UPI',
      ...
      btn_confirm: "✓ I've Completed the Transaction — Confirm Order",
      ...
      verifying: 'Processing Order Confirmation...'
    },
    privacy: {
      ...
      sec2_title: '2. Secure Ordering & Refund Policy',
      sec2_desc: 'The booking advance fee of ₹129 is collected through our secure ordering system to filter out spam inquiries and is 100% fully refundable upon final PC delivery or build cancellation.',
  ...
  ta: {
    ...
    hero: {
      ...
      p: 'உங்களின் தேவைகளுக்கு ஏற்ப வடிவமைக்கப்பட்ட உயர் செயல்திறன் கொண்ட தனிப்பயன் கணினிகள். விளையாட்டாளர்கள், படைப்பாளர்கள் மற்றும் நிபுணர்களுக்காக உருவாக்கப்பட்டது. பாதுகாப்பான ஆர்டர் முறையுடன் கூடிய நம்பகமான வன்பொருள் தீர்வுகள்.',
    ...
    about: {
      ...
      feat3_title: 'Ready Out of the Box',
      feat3_desc: 'OS நிறுவப்பட்டு, டிரைவர்கள் புதுப்பிக்கப்பட்டு, கட்டமைக்கப்பட்டுள்ளது.',
    ...
    products: {
      ...
      tiers: {
        ...
        performance: {
          ...
          specs: ['Intel Core i9 / Ryzen 9', '64 GB DDR5 6000 MHz', '2 TB NVMe + 2 TB HDD', 'RTX 4070 Ti Super', 'பிரீமியம் ஏர்ஃபுளோ கேஸ்']
        },
        elite: {
          tier: 'எலைட் தொடர்',
    ...
    payment: {
      booking: 'ஆர்டர் உறுதிப்படுத்தல்',
      confirm: 'உங்கள் ஆர்டரை உறுதிப்படுத்தவும்',
      ...
      advance_lbl: 'முன்பதிவு முன்பணம் (பாதுகாப்பான சரிபார்ப்பு)',
      ...
      btn_continue: 'ஆர்டர் உறுதிப்படுத்தலுக்குத் தொடரவும் →',
      sec_payment: 'பாதுகாப்பான பரிவர்த்தனை சரிபார்ப்பு · டெலிவரியின் போது முழுமையாக திருப்பித் தரப்படும்',
      step_2: 'படி 2 · பாதுகாப்பான பரிவர்த்தனை சரிபார்ப்பு',
      pay_via: 'UPI மூலம் ₹{amount} செலுத்தி ஆர்டரை உறுதி செய்யவும்',
      ...
      btn_confirm: '✓ நான் பரிவர்த்தனையை முடித்துவிட்டேன் — ஆர்டரை உறுதிசெய்',
      ...
      r_phone: 'தொலைபேசி',
      r_utr: 'UTR / குறிப்பு',
      r_amount: 'பரிவர்த்தனை தொகை',
      btn_form: 'ஆர்டர் விவரங்கள் படிவத்தை நிரப்பவும் →',
      btn_later: 'பிறகு நிரப்புகிறேன்',
      verifying: 'ஆர்டர் உறுதிப்படுத்தல் செயலாக்கப்படுகிறது...'
    },
    privacy: {
      ...
      sec2_title: '2. பாதுகாப்பான ஆர்டர் & பணத்தைத் திரும்பப் பெறுதல் கொள்கை',
      sec2_desc: 'தேவையற்ற விசாரணைகளைத் தவிர்க்கவும் பாதுகாப்பான ஆர்டர் முறையை உறுதிப்படுத்தவும் முன்பதிவு முன்பணக் கட்டணமான ₹129 வசூலிக்கப்படுகிறது. கணினி முழுமையாக விநியோகிக்கப்படும் போதோ அல்லது ஆர்டர் ரத்து செய்யப்படும் போதோ இந்தத் தொகை 100% முழுமையாகத் திருப்பித் தரப்படும்.',
